...
const Hero: React.FC = () => {
  return (
    <section id="about" className="min-h-[90vh] flex items-center py-20 px-4 md:px-8 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          >
            ...
            <Button variant="outline" size="lg" className="border-purple-600 text-purple-600 hover:bg-purple-100 dark:hover:bg-purple-900/30" asChild>
              <a href="#experience">
                View My Work
                <ArrowRight className="ml-2 h-4 w-4" />
              </a>
            </Button>
            <Button variant="ghost" size="lg" className="text-purple-600 hover:bg-purple-100 dark:hover:bg-purple-900/30" asChild>
